...
// * @author ben
// * @date 2024/4/8 16:13
// * @description 向商户同步支付状态 - 消费者
// **/
//
//@Slf4j
//@Configuration
//public class ConsumerNotifyConfig {
//
//
//    @Autowired
//    private PayinOrderNotifyService payinOrderNotifyService;
//
//    private static final String TOPIC = "NOTIFY-TOPIC";
//    private static final String CONSUMER_GROUP = "NotifyConsumerGroup";
//
...
//                }
//
//                boolean b = payinOrderNotifyService.payinOrderNotify(body);
