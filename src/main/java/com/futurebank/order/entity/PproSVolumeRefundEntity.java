...
@ApiModel(value = "PproSVolumeRefund", description = "批量退款记录表")
public class PproSVolumeRefundEntity implements Serializable {
    private static final long serialVersionUID = 494623016504565416L;
