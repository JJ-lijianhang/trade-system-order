...
/**
 * 基于提供文件内容生成的退款资金拒绝表(PproRRefundFundsrejected)实体类
 *
 * @author ben
...
@ApiModel(value = "PproRRefundFundsrejected", description = "基于提供文件内容生成的退款资金拒绝表")
public class PproRRefundFundsrejectedEntity implements Serializable {
    private static final long serialVersionUID = -71162782627609421L;
