...
@ApiModel(value = "PproSChargeback", description = "退单记录表")
public class PproSChargebackEntity implements Serializable {
    private static final long serialVersionUID = 126993690987825886L;
     ...
     * 商户交易ID，商户系统中的交易标识符
     */
    @ApiModelProperty(value = "商户交易ID，商户系统中的交易标识符")
     ...
     * 费用类型，退单相关的费用类型
     */
    @ApiModelProperty(value = "费用类型，退单相关的费用类型")
