...
/**
 * 基于提供文件内容生成的退款成功表(PproRRefundSucceeded)实体类
 *
 * @author ben
 * @since 2024-05-22 15:52:16
 */
@Data
@EqualsAndHashCode(callSuper = false)
@ApiModel(value = "PproRRefundSucceeded", description = "基于提供文件内容生成的退款成功表")
public class PproRRefundSucceededEntity implements Serializable {
    private static final long serialVersionUID = 787591209010599642L;
