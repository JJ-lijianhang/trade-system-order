...
/**
 * 资金缺失交易记录表(PproRTransactionFundsmissing)实体类
 *
 * @author ben
 * @since 2024-05-22 15:52:19
 */
@Data
@EqualsAndHashCode(callSuper = false)
@ApiModel(value = "PproRTransactionFundsmissing", description = "资金缺失交易记录表")
public class PproRTransactionFundsmissingEntity implements Serializable {
    private static final long serialVersionUID = 252586428144787874L;
     ...
     * 失败类型，指明失败的原因分类
     */
    @ApiModelProperty(value = "失败类型，指明失败的原因分类")
     ...
     * 失败时间戳，交易失败的时间点
     */
    @ApiModelProperty(value = "失败时间戳，交易失败的时间点")
     ...
     * 资金缺失时间戳，发现资金缺失的时间点
     */
    @ApiModelProperty(value = "资金缺失时间戳，发现资金缺失的时间点")
    private String fundsmissingts;

    /**
     * 错误文本，交易失败或异常时的错误描述
     */
    @ApiModelProperty(value = "错误文本，交易失败或异常时的错误描述")
