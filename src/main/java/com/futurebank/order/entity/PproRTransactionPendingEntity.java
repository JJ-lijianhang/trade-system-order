...
/**
 * 待处理交易记录表(PproRTransactionPending)实体类
 *
 * @author ben
 * @since 2024-05-22 15:52:22
 */
@Data
@EqualsAndHashCode(callSuper = false)
@ApiModel(value = "PproRTransactionPending", description = "待处理交易记录表")
public class PproRTransactionPendingEntity implements Serializable {
    private static final long serialVersionUID = 512435709886470986L;
     ...
     * 失败时间戳，交易失败的时间
     */
    @ApiModelProperty(value = "失败时间戳，交易失败的时间")
    private String failedts;

    /**
     * 存疑时间戳，交易存疑的时间
     */
    @ApiModelProperty(value = "存疑时间戳，交易存疑的时间")
