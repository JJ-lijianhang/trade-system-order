...
import com.futurebank.order.service.payin.PayinOrderQueryService;
...
public class PayinOrderQueryServiceImpl implements PayinOrderQueryService {
    ...
    @Override
    public void orderQuery(PaymentOrderEntity paymentOrderEntity, PaymentProviderEntity paymentProviderEntity) throws Exception {
