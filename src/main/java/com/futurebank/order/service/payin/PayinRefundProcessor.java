...
public class PayinRefundProcessor {
    ...
    public CommonResp processRefund(String platformOrderNo) throws Exception {

        List<PaymentOrderEntity> refundOrderList = paymentService.getPaymentOrderEntity(platformOrderNo);
